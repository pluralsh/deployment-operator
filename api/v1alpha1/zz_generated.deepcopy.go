...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetricsAggregateSpec) DeepCopyInto(out *MetricsAggregateSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetricsAggregateSpec.
func (in *MetricsAggregateSpec) DeepCopy() *MetricsAggregateSpec {
	if in == nil {
		return nil
	}
	out := new(MetricsAggregateSpec)
	in.DeepCopyInto(out)
	return out
}
