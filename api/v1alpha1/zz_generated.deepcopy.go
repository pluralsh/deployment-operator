...
func (in *ClusterAttributes) DeepCopyInto(out *ClusterAttributes) {
	*out = *in
	...
	if in.Kubeconfig != nil {
		...
		*out = new(client.KubeconfigAttributes)
		(*in).DeepCopyInto(*out)
	}
	if in.CloudSettings != nil {
		in, out := &in.CloudSettings, &out.CloudSettings
		*out = new(client.CloudSettingsAttributes)
		(*in).DeepCopyInto(*out)
	}
	if in.ProjectID != nil {
	...
	if in.UpgradePlan != nil {
		...
		*out = new(client.UpgradePlanAttributes)
		(*in).DeepCopyInto(*out)
	}
	if in.NodePools != nil {
		in, out := &in.NodePools, &out.NodePools
		*out = make([]*client.NodePoolAttributes, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(client.NodePoolAttributes)
				(*in).DeepCopyInto(*out)
			}
		}
	}
	if in.ReadBindings != nil {
		...
		*out = make([]*client.PolicyBindingAttributes, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(client.PolicyBindingAttributes)
				(*in).DeepCopyInto(*out)
			}
		}
	}
	if in.WriteBindings != nil {
		in, out := &in.WriteBindings, &out.WriteBindings
		*out = make([]*client.PolicyBindingAttributes, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
	...
	if in.Tags != nil {
		...
		*out = make([]*client.TagAttributes, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(client.TagAttributes)
				**out = **in
			}
		}
	}
