...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DockerComposeSpec) DeepCopyInto(out *DockerComposeSpec) {
	*out = *in
	if in.Version != nil {
	...
	if in.Services != nil {
		...
		*out = make(types.Services, len(*in))
		for key, val := range *in {
	...
	if in.Networks != nil {
		...
		*out = make(types.Networks, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DockerComposeSpec.
func (in *DockerComposeSpec) DeepCopy() *DockerComposeSpec {
	if in == nil {
		return nil
	}
	out := new(DockerComposeSpec)
