...
func RunServerGroupsScraperInBackgroundOrDie(ctx context.Context, config *rest.Config) {
	...
	err = helpers.BackgroundPollUntilContextCancel(ctx, func() time.Duration { return serverGroupsScraperPollingInterval }, false, true, func(_ context.Context) (done bool, err error) {
