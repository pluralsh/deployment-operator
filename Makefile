...
run-client-gen: client-gen
	$(CLIENT_GEN) --clientset-name versioned --input-base github.com/pluralsh/deployment-operator/apis --input pipelines/v1alpha1 --output-base ./ --output-package github.com/pluralsh/deployment-operator/generated/client/clientset --go-header-file hack/boilerplate.go.txt
...
run-lister-gen: lister-gen
	$(LISTER_GEN) --input-dirs github.com/pluralsh/deployment-operator/apis/pipelines/v1alpha1 --output-base ./ --output-package github.com/pluralsh/deployment-operator/generated/client/listers --go-header-file hack/boilerplate.go.txt
