...
var (
	...
	argDatadog                         = flag.Bool("datadog", false, "Enable datadog integration for detailed application profiling. By default it will push to http://datadog.monitoring.svc.cluster.local:8125")
