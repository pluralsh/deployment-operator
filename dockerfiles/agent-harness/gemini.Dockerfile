...
COPY --from=gemini /usr/local/lib/node_modules/@google/gemini-cli@latest /usr/local/lib/node_modules/@google/gemini-cli@latest
...
USER root
RUN chown -R 65532:65532 /usr/local/bin/gemini /usr/local/lib/node_modules/@google/gemini-cli@latest /usr/bin/node
