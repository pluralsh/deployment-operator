...
4. Persist report via `mcp__plural__updateAgentRunAnalysis`.
...
`mcp__plural__updateAgentRunAnalysis` to persist it.
...
## 7. Error handling and retries for `mcp__plural__updateAgentRunAnalysis`

If an `mcp__plural__updateAgentRunAnalysis` attempt fails:
