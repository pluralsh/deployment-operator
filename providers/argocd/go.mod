...
require (
	...
	github.com/pluralsh/deployment-operator/provisioner v0.0.0-20230926070646-e0bf8331015d
...
replace (
	github.com/pluralsh/deployment-operator => ./../../operator
...
// ArgoCD replace to fix build
replace (
	// Opentelemetry fix for apiserver import
	...
	go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc => go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc v1.0.1
